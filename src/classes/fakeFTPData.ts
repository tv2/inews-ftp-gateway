let ftpData = [
	...
	{
		'externalId': '111fe69f:00d8a38e:5d70cb44',
		'name': 'sp:live rass/nygaard',
		'rank': 12,
		'payload': {
			...
			'iNewsStory': {
				'fields': {
					'pageNumber': '09',
					'title': 'SP:LIVE RASS/Nygaard TDF',
					'tjekSport': '1',
					'var2': 'Danmon låne',
					'externer': 'EX 7',
					'tapeTime': '105',
				...
				'cues': [
					...
					[
						...
						'INP1=KAM 4',
						'INP2=LIVE 1',
						'BYNAVN=TOULOUSE/ODENSE'
					],
					[
						'EKSTERN=SKYPE 1 spor 2'
					],
					[
						'kg direkte TOULOUSE',
						';0.00'
					...
					[
						'kg bund RASMUS STAGHØJ',
						'TV 2 SPORT',
						';x.xx'
					],
					[
						'kg bund BRIAN NYGAARD',
						'TV 2 SPORT',
						';x.xx'
					]
				],
				'id': '111fe69f:00d8a38e:5d70cb44',
